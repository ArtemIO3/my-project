...
const faqData = [
  ...
  },
  {
    ...
    answer: 'Sign in to your One Key account when booking to automatically see member-exclusive discounts on eligible properties across Expedia, Hotels.com, and Vrbo.'
  },
  {
    id: 6,
    question: 'Is One Key, the Expedia, Hotels.com and Vrbo travel rewards program, free?',
    answer: 'Yes, joining and using One Key is completely free. There are no membership fees to earn or redeem OneKeyCash rewards.'
  },
  {
    id: 7,
    question: 'How do I stay up to date on One Key?',
    answer: 'Enable email notifications in your account settings to receive the latest news, offers, and tier updates directly to your inbox.'
  },
  {
    id: 8,
    question: 'Using accounts outside of the US and UK',
    answer: 'One Key is available in select countries. If you are outside the US or UK, check the eligibility page in your account settings to see if your region is supported.'
  },
  {
    id: 9,
    ...
    answer: 'To delete your account or opt out of One Key, go to Account Settings > Privacy > Delete Account and follow the prompts. Note that deletion is permanent and any unused OneKeyCash will be forfeited.'
  }
];
